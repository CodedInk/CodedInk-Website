        ...
        <section className="pt-32 pb-20 px-6 flex items-center justify-center">
          ...
          >
            ...
            <input
              ...
              className="w-full rounded-lg bg-white/10 border border-white/10 px-3 py-2 text-white outline-none focus:border-purple-500 transition-colors"
            />
            {error && (
            ...
            <button
              ...
              className="mt-6 w-full rounded-lg bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2 transition-colors"
            >
